...
import { DashboardSubscriptionCardGroup } from '@/components/dashboard/landing/components/dashboard-settings';
...
export function DashboardLandingPage() {
  return (
    <div className={'grid flex-1 items-start gap-8 p-0 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3'}>
